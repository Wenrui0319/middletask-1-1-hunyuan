 ...
 */
import useUploadImage from '@/common/components/gallery/useUploadImage';
...
export default function VideoGalleryUploadImage({
  style,
  onUpload,
  onUploadStart,
  onUploadError,
}: Props) {
  const {getRootProps, getInputProps, isUploading, error} = useUploadImage({
    onUpload,
    onUploadStart,
    onUploadError,
  });
