        ...
        with gr.Row():
            ...
            with gr.Column(scale=9):
                with gr.Tabs(selected='gen_mesh_panel') as tabs_output:
                    ...
                    with gr.Tab('Qwen-Image-Edit'):
                        gr.HTML(f"<iframe src='{QWEN_EDIT_URL}' width='100%' height='{HTML_HEIGHT}px' frameborder='0'></iframe>")
                    with gr.Tab('SAM Segmentation'):
                        gr.HTML(f"<iframe src='{SAM_SEG_URL}' width='100%' height='{HTML_HEIGHT}px' frameborder='0'></iframe>")
                    with gr.Tab('Clothing Generation'):
                        gr.HTML(f"<iframe src='{CLOTHING_GEN_URL}' width='100%' height='{HTML_HEIGHT}px' frameborder='0'></iframe>")
                    with gr.Tab('Body Generation'):
                        gr.HTML(f"<iframe src='{BODY_GEN_URL}' width='100%' height='{HTML_HEIGHT}px' frameborder='0'></iframe>")
...
if __name__ == '__main__':
    ...
    """
    QWEN_EDIT_URL = "http://localhost:7861"
    SAM_SEG_URL = "http://localhost:8000"
    CLOTHING_GEN_URL = "YOUR_CLOTHING_GENERATION_URL_HERE"
    BODY_GEN_URL = "YOUR_BODY_GENERATION_URL_HERE"
