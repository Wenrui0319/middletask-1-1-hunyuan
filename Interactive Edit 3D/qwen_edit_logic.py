            ...
            with gr.Column(scale=2):
                with gr.Tabs() as tabs:
                    with gr.TabItem("图像编辑区 (Image Edit Area)"):
                        input_img = gr.Image(label="上传或拖拽图像 (Upload or Drag Image)", interactive=True, height=700, type="pil", image_mode='RGBA', elem_id="qwen_edit_input_image")
